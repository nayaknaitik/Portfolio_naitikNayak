...
const Page1 = () => {
  ...
  useGSAP(() => {
    gsap.from([ref.current, mainRef.current], {
      y: 100,
      duration: 0.8,
      delay: 0.7,
      opacity: 0,
  ...
  const gotTo = () => {
    window.location.href =
      "https://drive.google.com/file/d/17dc0iGzcD4uelJv_eVT80IL5W1f2_LwR/view?usp=drivesdk";
  };
  const gotTol = () => {
  ...
  return (
    <div className="bg-[#ebebe9] min-h-screen w-full rounded-b-4xl static flex flex-col items-center px-5 sm:px-10 mx-auto">
      ...
      <div
        className="hidden sm:flex justify-between w-full max-w-screen-lg mt-10"
        ref={ref}
      >
        ...
        <ul className="flex gap-5 items-center">
          <li
            className="cursor-pointer tracking-wide hover:scale-110 transition duration-200"
            onClick={gotTol}
          >
            LeetCode
          </li>
      ...
      <div
        ref={mainRef}
        className="flex flex-col items-center justify-center w-full text-center mt-70"
      >
        <img
