       ...
       <div className="flex flex-col items-center justify-center w-full bg-[#ebebe9] rounded-t-4xl rounded-b-4xl px-6 py-20">
         ...
         <div ref={refCard} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mt-16 w-full max-w-5xl">
           ...
           <div className="bg-white p-6 rounded-lg shadow-lg text-center transition-transform duration-200 hover:scale-105">
             ...
             <p className="opacity-80 mt-2">Design and create beautiful UIs that are enjoyable to use.</p>
           </div>
           ...
           <div className="bg-white p-6 rounded-lg shadow-lg text-center transition-transform duration-200 hover:scale-105">
             ...
             <p className="opacity-80 mt-2">Crafting sleek, user-friendly, and visually stunning web designs.</p>
           </div>
           ...
           <div className="bg-white p-6 rounded-lg shadow-lg text-center transition-transform duration-200 hover:scale-105">
             ...
             <p className="opacity-80 mt-2">I create seamless digital experiences that are both visually stunning and highly functional.</p>
           </div>
           ...
           <div className="bg-white p-6 rounded-lg shadow-lg text-center transition-transform duration-200 hover:scale-105">
             ...
             <p className="opacity-80 mt-2">Editing and creating content that is engaging.</p>
           </div>
         </div>
       </div>
     );
